...
const Home = () => {
  ...
  return (
    <div style={{ backgroundColor: 'black', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      <h1 style={{ textAlign: 'center', color: '#FFFFFF',  marginRight: '75rem', fontSize: '33px', fontStyle:'comic sans'}}>Omar A. White</h1>
      <div style={{ backgroundColor: 'green', borderRadius: '40px', padding: '1rem', margin: '16rem', textAlign: 'center', marginRight:'35rem', marginTop: '1rem'}}>
